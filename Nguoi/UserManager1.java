...
public void addProduct(Scanner scanner) {
    System.out.println("Thêm hoặc cập nhật sản phẩm:");
    ...
    if (existingProduct != null) {
        // Update the existing product's quantity and price if necessary
        System.out.println("Sản phẩm đã tồn tại. Bạn có thể cập nhật số lượng và giá.");
        ...
        System.out.print("Nhập giá mới (nhập -1 nếu không muốn thay đổi giá): ");
        double newPrice = getDoubleInput(scanner, "Giá trị không hợp lệ. Vui lòng nhập lại giá: ");
        ...
        System.out.println("Đã cập nhật số lượng và giá sản phẩm thành công.");
    } else {
